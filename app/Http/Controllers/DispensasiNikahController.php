...
class DispensasiNikahController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'file_surat_kua'        => 'required|file|mimes:pdf,jpg,png,jpeg|max:2048',
            ...
            'file_bukti_cerai_pria' => 'nullable|file|mimes:pdf,jpg,png,jpeg|max:2048',
            ...
            'file_bukti_cerai_wanita' => 'nullable|file|mimes:pdf,jpg,png,jpeg|max:2048',
        ]);
