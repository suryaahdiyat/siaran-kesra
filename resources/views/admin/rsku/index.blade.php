...
@section('content')
    <div class="container-fluid">
        <h1 class="mb-2 text-gray-800 h3">Surat Masuk > Rekomendasi SKU</h1>
        <p class="mb-4">Daftar semua permohonan Rekomendasi SKU yang masuk melalui sistem.</p>

        <div class="mb-4 shadow card">
            <div class="py-3 card-header">
                <form action="{{ route('admin.rsku.index') }}" method="GET" class="mb-3">
                ...
                @role('staff')
                    <a href="{{ route('admin.rsku.create') }}" class="m-0 font-weight-bold text-primary">Tambah data</a>
                @endrole
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    @role('staff')
                                        <td class="text-center justify-content-evenly d-flex">
                                            <a href="{{ route('admin.rsku.edit', $item->id) }}"
