...
@section('content')
    <div class="container my-5">
        <div class="">
            ...
            <form action="{{ route('admin.sl.update', $sl->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="jenis_surat" name="jenis_surat" required
                            value="{{ old('jenis_surat', $sl->jenis_surat) }}">
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="nama_pengantar" name="nama_pengantar" required
                            value="{{ old('nama_pengantar', $sl->nama_pengantar) }}">
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="alamat_pengantar" name="alamat_pengantar" required
                            value="{{ old('alamat_pengantar', $sl->alamat_pengantar) }}">
                    </div>
                    <x-dropdown-desa id="nama_desa" label="Nama Desa" :selected="old('nama_desa', $sl->nama_desa)" required />
