...
@section('content')
    <div class="container my-5">
        <div class="">
            ...
            <form action="{{ route('admin.liob.update', $liob->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <h5 class="mb-3">Surat Keluar > Edit Data Legalisasi Izin Orang Banyak</h5>
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="nama_pengantar" name="nama_pengantar" required
                            value="{{ old('nama_pengantar', $liob->nama_pengantar) }}">
                    </div>
                    <div class="mb-3 col-md-6">
