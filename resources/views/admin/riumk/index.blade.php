...
@section('content')
    <div class="container-fluid">
        <h1 class="mb-2 text-gray-800 h3">Surat Masuk > Rekomendasi Izin UMK</h1>
        <p class="mb-4">Daftar semua permohonan Rekomendasi Izin UMK yang masuk melalui sistem.</p>

        <div class="mb-4 shadow card">
            <div class="py-3 card-header">
                <form action="{{ route('admin.riumk.index') }}" method="GET" class="mb-3">
                ...
                <a href="{{ route('admin.riumk.create') }}" class="m-0 font-weight-bold text-primary">Tambah data</a>
            </div>
            <div class="card-body">
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center justify-content-evenly d-flex">
                                        <a href="{{ route('admin.riumk.edit', $item->id) }}"
