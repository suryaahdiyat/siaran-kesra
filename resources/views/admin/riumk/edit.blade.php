...
@section('content')
    <div class="container my-5">
        <div class="">
            ...
            <form action="{{ route('admin.riumk.update', $riumk->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <h5 class="mb-3">Surat Keluar > Edit Data Rekomendasi Izin UMK</h5>
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="nama_pengantar" name="nama_pengantar" required
                            value="{{ old('nama_pengantar', $riumk->nama_pengantar) }}">
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="alamat_pengantar" name="alamat_pengantar" required
                            value="{{ old('alamat_pengantar', $riumk->alamat_pengantar) }}">
                    </div>
                    <x-dropdown-desa id="nama_desa" label="Nama Desa" :selected="old('nama_desa', $riumk->nama_desa)" required />
                ...
                <div class="mt-4 d-flex justify-content-end">
                    <a href="{{ route('admin.riumk.index') }}" class="btn btn-secondary me-2">Batal</a>
